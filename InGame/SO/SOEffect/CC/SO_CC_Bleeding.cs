...
[CreateAssetMenu(fileName = "SO_CC_Bleeding", menuName = "InGameEffect/CC/Bleeding")]
public class SO_CC_Bleeding : SOBase_UnitEffectEvent
{
    ...
    private class PersonalVariable : UnitEffectPersonalVariableInstance
    {
        ...
        public override void OnStart()
        {
            ...
            objVFX = MgrObjectPool.Instance.ShowObj("FX_CC_Bleeding", Victim.GetUnitCenterPos());
        ...
        public override void OnUpdate()
        {
            if(Duration > 0.0f)
            {
                ...
                {
                    tickTimer -= 1.0f;
                    MgrInGameEvent.Instance.BroadcastDamageEvent(Caster, Victim, Victim.UnitStat.MaxHP * 0.03f, 0.0f, 1.0f, 10);
                }
        ...
        {
            MgrObjectPool.Instance.HideObj("FX_CC_Bleeding", objVFX);
            objVFX = null;
