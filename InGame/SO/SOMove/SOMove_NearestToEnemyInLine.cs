...
[CreateAssetMenu(fileName = "SOMove_NearestToEnemyInLine", menuName = "UnitMove/NearestToEnemyInLine")]
public class SOMove_NearestToEnemyInLine : SOBase_MoveUnit
{
    ...
    public override bool CheckIsChangeToMoveState(UnitBase _unitBase)
    {
        ...
        return mgrBattleSystem.CheckIsEnemyUnitInLine(_unitBase, _unitBase.transform.position, _unitBase.UnitStat.Range, _unitBase.UnitStat.WidthRange);
    }
    ...
    public override void Move(UnitBase _unitBase)
    {
        ...
        {
            listUnit.Clear();
            listUnit.AddRange(MgrBattleSystem.Instance.GetNearestEnemyUnitInLine(_unitBase, _unitBase.transform.position, _unitBase.UnitStat.Range, _unitBase.UnitStat.WidthRange));
