...
[CreateAssetMenu(fileName = "SOBullet_Bullet_C_Arch_01_S1", menuName = "Bullet/Bullet_C_Arch_01_S1")]
public class SOBullet_Bullet_C_Arch_01_S1 : SOBase_Bullet
{
    ...
    private class PersonalVariable : BulletPersonalVariableInstance
    {
        ...
        public override void OnHit()
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C_Arch_01_s1_2", 1.0f);
        }
    }
}
