...
[CreateAssetMenu(fileName = "SOBullet_Bullet_C_Arch_01_S2", menuName = "Bullet/Bullet_C_Arch_01_S2")]
public class SOBullet_Bullet_C_Arch_01_S2 : SOBase_Bullet
{
    ...
    private class PersonalVariable : BulletPersonalVariableInstance
    {
        ...
        {
            MgrInGameEvent.Instance.BroadcastDamageEvent(bulletComp.owner, bulletComp.target, bulletComp.bulletAtk * bulletComp.owner.GetUnitSkillFloatDataValue(1, "param.0"), bulletComp.bulletCriRate, bulletComp.bulletCriDmg);
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C_Arch_01_s2_2", 1.0f);
        }
    }
}
