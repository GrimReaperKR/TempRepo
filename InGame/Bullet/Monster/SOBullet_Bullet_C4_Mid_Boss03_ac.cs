...
[CreateAssetMenu(fileName = "SOBullet_Bullet_C4_Mid_Boss03_ac", menuName = "Bullet/Monster/Bullet_C4_Mid_Boss03_ac")]
public class SOBullet_Bullet_C4_Mid_Boss03_ac : SOBase_Bullet
{
    ...
    private class PersonalVariable : BulletPersonalVariableInstance
    {
        ...
        public void SetBezier()
        {
            ...
            {
                float upVel = Random.Range(2.0f, 6.0f);
            ...
            {
                float dowmVel = Random.Range(2.0f, 12.0f);
        ...
        public override void OnHit()
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C4_Mid_Boss03_ac_s1_2", 1.0f);
