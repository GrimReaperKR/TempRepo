...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_B_Arch_01_Turtle_S2", menuName = "UnitSkillEvent/B_Arch_01_Turtle_S2")]
public class B_Arch_01_Turtle_S2 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_B_Arch_01_s1_4", 1.0f);
            _victim.AddUnitEffect(MgrInGameData.Instance.GetUnitEffectByIndexNum((int)unitSkillData.Param[3]), _attacker, _victim, new float[] { 1.0f });
        }
        ...
        {
            GameObject objBullet = MgrBulletPool.Instance.ShowObj("Bullet_B_Arch_01_S2", unitBase.GetUnitCenterPos());
