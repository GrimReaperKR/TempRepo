...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_B_Arch_03_Ray_S1", menuName = "UnitSkillEvent/B_Arch_03_Ray_S1")]
public class B_Arch_03_Ray_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_B_Arch_03_s1_2", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            GameObject objBullet = MgrBulletPool.Instance.ShowObj("Bullet_B_Arch_03_S1", unitBase.GetUnitCenterPos() + v3Dir * 1.5f);
            objBullet.GetComponent<Bullet>().SetBullet(unitBase, unitBase.EnemyTarget);

            MgrSound.Instance.PlayOneShotSFX("SFX_B_Arch_03_s1_1", 1.0f);
        }
