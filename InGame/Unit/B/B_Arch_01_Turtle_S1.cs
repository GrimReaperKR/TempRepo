...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_B_Arch_01_Turtle_S1", menuName = "UnitSkillEvent/B_Arch_01_Turtle_S1")]
public class B_Arch_01_Turtle_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_B_Arch_01_s2_2", 1.0f);
        }
        ...
        {
            GameObject objBullet = MgrBulletPool.Instance.ShowObj("Bullet_B_Arch_01_S1", unitBase.GetUnitCenterPos());
