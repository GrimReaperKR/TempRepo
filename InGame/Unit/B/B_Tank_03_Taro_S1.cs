...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_B_Tank_03_Taro_S1", menuName = "UnitSkillEvent/B_Tank_03_Taro_S1")]
public class B_Tank_03_Taro_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_B_Tank_03_s1_2", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_B_Tank_03_Taro_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
