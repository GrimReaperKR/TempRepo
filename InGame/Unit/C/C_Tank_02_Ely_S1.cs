...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C_Tank_02_Ely_S1", menuName = "UnitSkillEvent/C_Tank_02_Ely_S1")]
public class C_Tank_02_Ely_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C_Tank_02_s1_b", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_C_Tank_02_Ely_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
