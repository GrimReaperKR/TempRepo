...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C_War_01_Nino_S2", menuName = "UnitSkillEvent/C_War_01_Nino_S2")]
public class C_War_01_Nino_S2 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C_War_01_s2_3", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_C_War_01_Nino_skill2_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
