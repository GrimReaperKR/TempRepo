...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C_Arch_01_Mafia_S1", menuName = "UnitSkillEvent/C_Arch_01_Mafia_S1")]
public class C_Arch_01_Mafia_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        {
            GameObject objBullet = MgrBulletPool.Instance.ShowObj("Bullet_C_Arch_01_S1", unitBase.GetUnitCenterPos());
