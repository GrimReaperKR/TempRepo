...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C_Tank_01_Ent_S1", menuName = "UnitSkillEvent/C_Tank_01_Ent_S1")]
public class C_Tank_01_Ent_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C_Tank_01_s1_2", 1.0f);
        }
