...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C_War_01_Nino_S1", menuName = "UnitSkillEvent/C_War_01_Nino_S1")]
public class C_War_01_Nino_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C_War_01_s1_2", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_C_War_01_Nino_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos() + new Vector3(Random.Range(-0.25f, 0.25f), Random.Range(-0.2f, 0.25f), 0.0f));
        }
