...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_A_Tank_02_Chu_S1", menuName = "UnitSkillEvent/A_Tank_02_Chu_S1")]
public class A_Tank_02_Chu_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_A_Tank_02_s1_2", 1.0f);

            if (MathLib.CheckPercentage((float)unitSkillData.Param[1]))
                _victim.AddUnitEffect(MgrInGameData.Instance.GetUnitEffectByIndexNum((int)unitSkillData.Param[2]), _attacker, _victim, new float[] { 1.0f });
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_A_Tank_02_Chu_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
