...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_A_War_02_Lavi_S1", menuName = "UnitSkillEvent/A_War_02_Lavi_S1")]
public class A_War_02_Lavi_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_A_War_02_s1_2", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_A_War_02_Lavi_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
