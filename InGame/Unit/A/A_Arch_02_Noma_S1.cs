...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_A_Arch_02_Noma_S1", menuName = "UnitSkillEvent/A_Arch_02_Noma_S1")]
public class A_Arch_02_Noma_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_A_Arch_02_s1_2", 1.0f);
        }
        ...
        {
            GameObject objBullet = MgrBulletPool.Instance.ShowObj("Bullet_A_Arch_02_S1", unitBase.GetUnitCenterPos());
