...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_S_War_03_Ventra_S1", menuName = "UnitSkillEvent/S_War_03_Ventra_S1")]
public class S_War_03_Ventra_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_S_War_03_s1_3", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_S_War_03_Ventra_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
