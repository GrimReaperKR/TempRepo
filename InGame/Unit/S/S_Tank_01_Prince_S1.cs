...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_S_Tank_01_Prince_S1", menuName = "UnitSkillEvent/S_Tank_01_Prince_S1")]
public class S_Tank_01_Prince_S1 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_S_Tank_01_s1_3", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj("FX_S_Tank_01_Prince_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
