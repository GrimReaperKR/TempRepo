...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C1_Normal_Mnstr00_ad_S1", menuName = "UnitSkillEvent/Monster/C1_Normal_Mnstr00_ad_S1")]
public class C1_Normal_Mnstr00_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C1_Normal_Mnstr00_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C1_Normal_Mnstr00_d") ? "SFX_Normal_Mnstr00_Knife_2" : "SFX_Normal_Mnstr00_Bat_2", 1.0f);
        }
        ...
        {
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C1_Normal_Mnstr00_d") ? "SFX_Normal_Mnstr00_Knife_1" : "SFX_Normal_Mnstr00_Bat_1", 1.0f);
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C1_Normal_Mnstr00_d") ? "FX_Forest_War_Goblin_d_hit" : "FX_Forest_War_Goblin_a_hit", unitBase.EnemyTarget.GetUnitCenterPos());
