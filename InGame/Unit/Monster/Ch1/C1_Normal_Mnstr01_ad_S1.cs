...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C1_Normal_Mnstr01_ad_S1", menuName = "UnitSkillEvent/Monster/C1_Normal_Mnstr01_ad_S1")]
public class C1_Normal_Mnstr01_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C1_Normal_Mnstr01_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C1_Normal_Mnstr01_s1_2", 1.0f);
        }
        ...
        {
            MgrSound.Instance.PlayOneShotSFX("SFX_C1_Normal_Mnstr01_s1_1", 1.0f);
            ...
            GameObject objBullet = MgrBulletPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C1_Normal_Mnstr01_d") ? "Bullet_Normal_Mnstr_01_d_S1" : "Bullet_Normal_Mnstr_01_a_S1", unitBase.GetUnitCenterPos());
