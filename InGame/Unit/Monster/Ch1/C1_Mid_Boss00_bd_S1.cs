...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C1_Mid_Boss00_bd_S1", menuName = "UnitSkillEvent/Monster/C1_Mid_Boss00_bd_S1")]
public class C1_Mid_Boss00_bd_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C1_Mid_Boss00_d") ? "d" : "b");
    }
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C1_Mid_Boss00_bd_s1_2", 1.0f);
        }
        ...
        {
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C1_Mid_Boss00_d") ? "FX_monster rat_mid boss_d_skill-hit" : "FX_monster rat_mid boss_b_skill-hit", unitBase.EnemyTarget.GetUnitCenterPos());
