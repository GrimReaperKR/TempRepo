...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C1_Normal_Mnstr02_ad_S1", menuName = "UnitSkillEvent/Monster/C1_Normal_Mnstr02_ad_S1")]
public class C1_Normal_Mnstr02_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C1_Normal_Mnstr02_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C1_Normal_Mnstr02_d") ? "SFX_Normal_Mnstr02_Knuckle_2" : "SFX_Normal_Mnstr02_Gloves_2", 1.0f);
        }
        ...
        {
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C1_Normal_Mnstr02_d") ? "SFX_Normal_Mnstr02_Knuckle_1" : "SFX_Normal_Mnstr02_Gloves_1", 1.0f);
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C1_Normal_Mnstr02_d") ? "FX_Forest_Tank_Goblin_d_hit" : "FX_Forest_Tank_Goblin_a_hit", unitBase.EnemyTarget.GetUnitCenterPos());
