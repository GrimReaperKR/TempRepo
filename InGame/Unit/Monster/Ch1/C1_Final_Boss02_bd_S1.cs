...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C1_Final_Boss02_bd_S1", menuName = "UnitSkillEvent/Monster/C1_Final_Boss02_bd_S1")]
public class C1_Final_Boss02_bd_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C1_Final_Boss02_d") ? "d" : "b");
    }
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C1_Final_Boss02_bd_s1_3", 1.0f);
        }
