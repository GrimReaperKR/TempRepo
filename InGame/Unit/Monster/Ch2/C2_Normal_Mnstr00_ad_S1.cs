...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C2_Normal_Mnstr00_ad_S1", menuName = "UnitSkillEvent/Monster/C2_Normal_Mnstr00_ad_S1")]
public class C2_Normal_Mnstr00_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C2_Normal_Mnstr00_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C2_Normal_Mnstr00_d") ? "SFX_Normal_Mnstr00_Axe_2" : "SFX_Normal_Mnstr00_Metal blunt_2", 1.0f);
        }
        ...
        {
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C2_Normal_Mnstr00_d") ? "SFX_Normal_Mnstr00_Axe_1" : "SFX_Normal_Mnstr00_Metal blunt_1", 1.0f);
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C2_Normal_Mnstr00_d") ? "FX_Desert_War_Mummy_d_hit" : "FX_Desert_War_Mummy_a_hit", unitBase.EnemyTarget.GetUnitCenterPos());
