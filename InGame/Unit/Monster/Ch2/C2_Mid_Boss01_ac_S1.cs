...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C2_Mid_Boss01_ac_S1", menuName = "UnitSkillEvent/Monster/C2_Mid_Boss01_ac_S1")]
public class C2_Mid_Boss01_ac_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C2_Mid_Boss01_c") ? "c" : "a");
    }
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C2_Mid_Boss01_ac_s1_3", 1.0f);
        }
        ...
        {
            MgrSound.Instance.PlayOneShotSFX("SFX_C2_Mid_Boss01_ac_s1_2", 1.0f);
            TaskSkill().Forget();
        }
        ...
        private async UniTaskVoid TaskSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C2_Mid_Boss01_c") ? "FX_Sphinx_mid boss_c_skill_hit" : "FX_Sphinx_mid boss_a_skill_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
    }
}
