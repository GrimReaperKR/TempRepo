...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C3_Mid_Boss00_ac_S1", menuName = "UnitSkillEvent/Monster/C3_Mid_Boss00_ac_S1")]
public class C3_Mid_Boss00_ac_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C3_Mid_Boss00_c") ? "c" : "a");
    }
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C3_Mid_Boss00_ac_s1_2", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C2_Mid_Boss01_c") ? "FX_ice golem_mid boss_c_skill_hit" : "FX_ice golem_mid boss_a_skill_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        }
