...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C3_Final_Boss02_bd_S1", menuName = "UnitSkillEvent/Monster/C3_Final_Boss02_bd_S1")]
public class C3_Final_Boss02_bd_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C3_Final_Boss02_d") ? "d" : "b");
    }
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX(atkCnt == 1 ? "SFX_C3_Final_Boss02_bd_s1_3" : "SFX_C3_Final_Boss02_bd_s1_4", 1.0f);
        }
        ...
        public override void EventTriggerSkill()
        {
            ...
            {
                MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C3_Final_Boss02_d") ? "FX_Dullahan_boss_d_skill1_hit" : "FX_Dullahan_boss_b_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
