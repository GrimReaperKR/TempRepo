...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C3_Normal_Mnstr02_ad_S1", menuName = "UnitSkillEvent/Monster/C3_Normal_Mnstr02_ad_S1")]
public class C3_Normal_Mnstr02_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C3_Normal_Mnstr02_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_Normal_Mnstr02_Take_Down_4", 1.0f);
        }
