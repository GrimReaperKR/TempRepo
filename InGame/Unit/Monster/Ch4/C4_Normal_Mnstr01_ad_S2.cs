...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C4_Normal_Mnstr01_ad_S2", menuName = "UnitSkillEvent/Monster/C4_Normal_Mnstr01_ad_S2")]
public class C4_Normal_Mnstr01_ad_S2 : SOBase_UnitSkillEvent
{
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_C4_Normal_Mnstr01_s2_2", 1.0f);
        }
        ...
        {
            MgrSound.Instance.PlayOneShotSFX("SFX_C4_Normal_Mnstr01_s2_1", 1.0f);

            GameObject objBullet = MgrBulletPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C4_Normal_Mnstr01_d") ? "Bullet_C4_Normal_Mnstr_01_d_S2" : "Bullet_C4_Normal_Mnstr_01_a_S2", unitBase.GetUnitCenterPos());
