...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C4_Normal_Mnstr02_ad_S1", menuName = "UnitSkillEvent/Monster/C4_Normal_Mnstr02_ad_S1")]
public class C4_Normal_Mnstr02_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C4_Normal_Mnstr02_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX("SFX_Normal_Mnstr02_Metal_body slam_2", 1.0f);
        }
        ...
        {
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C4_Normal_Mnstr02_d") ? "FX_Ghost_Tank_Armort_d_skill1_hit" : "FX_Ghost_Tank_Armort_a_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        ...
        public override void OnSkill()
        {
            ...
            unitBase.PlayTimeline(unitBase.UnitIndex.Equals("C4_Normal_Mnstr02_d") ? 1 : 0);
        }
    }
}
