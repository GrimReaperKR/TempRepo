...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C4_Normal_Mnstr00_ad_S1", menuName = "UnitSkillEvent/Monster/C4_Normal_Mnstr00_ad_S1")]
public class C4_Normal_Mnstr00_ad_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C4_Normal_Mnstr00_d") ? "d" : "a");
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        public override void OnGiveDamageAction(UnitBase _attacker, UnitBase _victim, int _dmgChannel, float _damage)
        {
            ...
            MgrSound.Instance.PlayOneShotSFX(unitBase.UnitIndex.Equals("C4_Normal_Mnstr00_d") ? "SFX_Normal_Mnstr00_Knife_2" : "SFX_Normal_Mnstr00_Big_Axe_2", 1.0f);
        }
        ...
        {
            MgrObjectPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C4_Normal_Mnstr00_d") ? "FX_Ghost_War_Skull_d_skill1_hit" : "FX_Ghost_War_Skull_a_skill1_hit", unitBase.EnemyTarget.GetUnitCenterPos());
        ...
        public override void OnSkill()
        {
            ...
            unitBase.PlayTimeline(unitBase.UnitIndex.Equals("C4_Normal_Mnstr00_d") ? 1 : 0);
        }
    }
}
