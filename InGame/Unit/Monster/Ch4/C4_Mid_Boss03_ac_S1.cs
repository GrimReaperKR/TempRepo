...
[CreateAssetMenu(fileName = "SOUnitSkillEvent_C4_Mid_Boss03_ac_S1", menuName = "UnitSkillEvent/Monster/C4_Mid_Boss03_ac_S1")]
public class C4_Mid_Boss03_ac_S1 : SOBase_UnitSkillEvent
{
    public override void InitializeSkill(UnitBase _unitBase)
    {
        ...
        _unitBase.Ska.skeleton.SetSkin(_unitBase.UnitIndex.Equals("C4_Mid_Boss03_c") ? "c" : "a");
    }
    ...
    private class PersonalVariable : UnitSkillPersonalVariableInstance
    {
        ...
        public override void EventTriggerSkill()
        {
            ...
            if (listUnit.Count < (int)bossSkillData.Param[1] && MgrBattleSystem.Instance.GetAllyBase() != null)
                listUnit.Add(MgrBattleSystem.Instance.GetAllyBase());

            int targetCnt = listUnit.Count > (int)bossSkillData.Param[1] ? (int)bossSkillData.Param[1] : listUnit.Count;

            for(int i = 0; i < targetCnt; i++)
            {
                GameObject objBullet = MgrBulletPool.Instance.ShowObj(unitBase.UnitIndex.Equals("C4_Mid_Boss03_c") ? "Bullet_C4_Mid_Boss03_c" : "Bullet_C4_Mid_Boss03_a", unitBase.GetUnitCenterPos() + Vector3.up * 1.5f);
            ...
            for(int i = 0; i < (int)bossSkillData.Param[2]; i++)
            {
                ...
                MgrUnitPool.Instance.ShowEnemyMonsterObj(unitBase.UnitIndex.Equals("C4_Mid_Boss03_c") ? "C4_Mid_Boss03_c_s" : "C4_Mid_Boss03_a_s", unitBase.TeamNum, v3Pos, true, unitBase);
